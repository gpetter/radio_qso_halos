...
from halomodelpy import clustering_fit, redshift_helper, pipeline, hm_calcs
import numpy as np
import sample
...
def lotss_selected_xcorr(rpscales, radiosfr_thresh=1000, boss=False):
    ...
    z_centers = eboss_zbins[:-1] + (eboss_zbins[1] - eboss_zbins[0])/2
