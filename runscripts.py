...
#measurements.lens_hiz()
#measurements.extended_jets(scales)
#measurements.lotss_selected_xcorr(rpscales=scales)
#measurements.bal_qso(scales)
sample.radio_match('dr7QSO', ['LOTSS_DR2', 'Apertif', 'FIRST'], 5.)
#sample.mask_randoms('desiLRG_edr')
